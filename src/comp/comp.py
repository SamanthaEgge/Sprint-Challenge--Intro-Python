...
# a = humans[name for name in humans if name[0] == 'D']
# a = [human for human in humans for human in humans if human.name[0] == 'D']
...
print("Ends with e:")
# b = [human.name[-1] == 'e' for human in humans]
...
# g = [Human(human.name.upper() for human in humans, human.age+5 for human in humans)]
# g = [Human(human.name.upper(), human.age+5) for human in humans]
# g = [Human(human.name.upper() and human.age+5 for human in humans)]
# g = Human([human.name.upper() for human in humans], [human.age+5 for human in humans])
# g = [human for human in humans if human is not None Human(human.name.upper(), human.age+5) else pass]
g = [Human(human.name.upper(),human.age+5) for human in humans]
print(g)
